    ...
    18: function (e, t, r) {
      ...
      function v() {
        ...
        return (
          ...
          (f.displayName = s(d, c, "GeneratorFunction")),
      ...
      function y(e, t) {
        ...
        return fetch("https://chatapi.databricks.com/".concat(e), {
          method: "POST",
          credentials: "include",
          headers: Object(u.a)({ "Content-Type": "application/json" }, r),
        ...
        return a.a.createElement(
          ...
          r.length > 0
            ? a.a.createElement(
                ...
                r.map(function (e) {
                  return a.a.createElement(A, { url: e });
                })
              )
            : null
        );
                    ...
                    switch ((e.prev = e.next)) {
                      case 0:
                        return (
                          ...
                          (e.prev = 1),
                          (e.next = 4),
                          y("doc_qa", { question: t, history: i.current })
                        );
                      case 4:
                        (a = e.sent), (e.next = 9);
                        break;
                          ...
                          (s = c.related_to_azure_gcp) || !c.has_answer
                            ? (s
                              ...
                              (n.answer.answer = s
                                ? E.AZURE_GCP_ANSWER
                                : E.NO_ANSWER))
                            : (Object(l.renderCustomComponent)(S, c, !0),
                              c.sources.length > 0 &&
                ...
                a.a.createElement(l.Widget, {
                  ...
                  handleQuickButtonClicked: function () {
                    Object(l.setQuickButtons)([]),
                      ...
                      Object(l.renderCustomComponent)(_);
                  },
                    ...
                    return (function (e) {
                      ...
                      return (
                        Object(n.useEffect)(
                          function () {
                            o &&
                              y("metrics", { event: "opened_assistant" }).catch(
                                function () {}
                              );
                          },
                          [o]
      ...
      i.a.render(a.a.createElement(q, null), C);
    },
  },
  [[10, 1, 2]],
]);
